    ...
    <div class="content">
      ...
      <form class="register-form" action="" method="post">
        <center>
          ...
          <input type="text" class="textbox" name="stationname" placeholder="Station Name"  value='<?php //echo $stationcode ?>' required title="Name of the Railway station.">
          ...
          <input type="number" class="textbox" id="distance" name="distance" placeholder="Distance from Source Station in KMs." required title="Distance from the source station of the train in KMs.">
