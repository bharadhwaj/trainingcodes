        ...
        <div align="center" class="col-md-6 col-md-offset-3">
          <fieldset class="table-display">
            ...
            <form class="register-form" action="" method="post">
                ...
                <input type="number" class="textbox-register" id="distance" name="distance" min = "0" max="4999" value='<?php echo $distance; ?>' placeholder="Distance from Source Station in KMs." required title="Distance from the source station of the train in KMs.">
